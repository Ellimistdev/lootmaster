      ...
      <div className="mt-5 border-t border-zinc-800 pt-5">
        <div className="space-y-3 text-sm text-zinc-300">
          ...
          <ol className="list-decimal space-y-2 pl-5 marker:text-zinc-500">
            ...
            <li>If the item contains both the spec's first and second priority stats in an ordered priority (for example, Crit &gt; Haste), it is always S tier. Rank 0.5 means the larger stat budget is on the first-priority stat; rank 1 means it leans toward the second-priority stat.</li>
